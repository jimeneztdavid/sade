 ...
 <div class="row">
                          ...
                          <section>
                            <div class="row">
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" class="form-control" id="lapso_inscripcion" name="lapso_inscripcion" placeholder="Ej: 2018-02" disabled>
                              </div>
                              <div class="form-group col-md-6">
                              ...
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" placeholder="Ej: 19/10/1997" disabled>
                              </div>
                              <div class="form-group col-md-6">
  ...
  <div class="modal fade nuevo-atleta" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header">
                  <h4 class="modal-title" id="myLargeModalLabel">Registrar atleta</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              </div>
              <div class="modal-body">
                  <form id="form-nuevo-atleta" enctype="multipart/form-data">
                      <div class="this-for-steps">
                          <h3>Principal</h3>
                          <section>
                            <div class="row">
                              <div class="form-group col-md-6">
                                  <label for="nombre" class="control-label">Nombre:</label>
                                  <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ej: Pedro" maxlength="40">
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="apellido" class="control-label">Apellido:</label>
                                  <input type="text" class="form-control" id="apellido" name="apellido" placeholder="Ej: Perez" maxlength="40">
                              </div>
                              <div class="form-group col-md-2">
                                  <label for="nacionalidad" class="control-label">Nacionalidad:</label>
                              ...
                              <div class="form-group col-md-6">
                                  <label for="pasaporte" class="control-label">Pasaporte:</label>
                                  <input type="text" class="form-control" id="pasaporte" name="pasaporte" placeholder="Ej: 12345678">
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="correo" class="control-label">Correo Electrónico:</label>
                                  <input type="email" class="form-control" id="correo" name="correo" placeholder="Ej: ejemplo@dominio.com">
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="telefono_movil" class="control-label">Teléfono movil:</label>
                                  <input type="tel" class="form-control" id="telefono_movil" name="telefono_movil" placeholder="Ej: 04146145252" maxlength="11">
                              </div>
                            </div>
                          </section>
                          <h3>Domicilio</h3>
                          <section>
                            <div class="row">
                              <div class="form-group col-md-6">
                                  <label for="telefono_casa" class="control-label">Teléfono de Casa:</label>
                                  <input type="text" class="form-control" id="telefono_casa" name="telefono_casa" placeholder="Ej: 02681234567" maxlength="11">
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="twitter" class="control-label">Twitter:</label>
                                  <input type="text" class="form-control" id="twitter" name="twitter" placeholder="Ej: @usuario">
                              </div>
                              <div class="form-group col-md-12">
                                  <label for="direccion" class="control-label">Dirección:</label>
                                  <textarea class="form-control" name="direccion" id="direccion" placeholder="Ej: Calle Churuguara, entre ..."></textarea>
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="municipio" class="control-label">Municipio:</label>
                                  <input type="text" class="form-control" id="municipio" name="municipio" placeholder="Ej: Miranda">
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="parroquia" class="control-label">Parroquia:</label>
                                  <input type="text" class="form-control" id="parroquia" name="parroquia" placeholder="Ej: San Gabriel">
                              </div>
                            </div>
                          </section>
                          <h3>Academicos</h3>
                          <section>
                            <div class="row">
                              <div class="form-group col-md-6">
                                  <label for="pnf_id" class="control-label">PNF:</label>
                                  <select id="pnf_id" name="pnf_id" class="form-control">
                                    @foreach ($pnfs as $pnf)
                                    <option value="{{ $pnf->id }}"> {{ $pnf->nombre }}</option>
                                    @endforeach
                                  </select>
                              ...
                              <div class="form-group col-md-6">
                                  <label for="lapso_inscripcion" class="control-label">Lapso de Inscripción:</label>
                                  <input type="text" class="form-control" id="lapso_inscripcion" name="lapso_inscripcion" placeholder="Ej: 2018-02" readonly="readonly" >
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="disciplina_id" class="control-label">Disciplina:</label>
                              ...
                              <div class="form-group col-md-6">
                                  <label for="fecha_nacimiento" class="control-label">Fecha de Nacimiento:</label>
                                  <input type="text" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" placeholder="Ej: 19/10/1997" readonly="readonly" >
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="lugar_nacimiento" class="control-label">Lugar de Nacimiento:</label>
                                  <input type="text" class="form-control" id="lugar_nacimiento" name="lugar_nacimiento" placeholder="Ej: Coro">
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="tipo_sangre" class="control-label">Tipo de sangre:</label>
                          ...
                          <section>
                            <div class="row">
                              <div class="form-group col-md-6">
                                  <label for="estatura" class="control-label">Estatura:</label>
                                  <input type="text" class="form-control" id="estatura" name="estatura" placeholder="Ej: 1.80m" maxlength="5">
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="peso" class="control-label">Peso:</label>
                                  <input type="text" class="form-control" id="peso" name="peso" placeholder="Ej: 80k" maxlength="4">
                              </div>
                              <div class="form-group col-md-4">
                                  <label for="talla_zapato" class="control-label">Talla de Zapato:</label>
                                  <input type="number" class="form-control" id="talla_zapato" name="talla_zapato" placeholder="Ej: 40" maxlength="2" min="30" max="48">
                              </div>
                              <div class="form-group col-md-4">
                                  <label for="talla_franela" class="control-label">Talla de Franela:</label>
                                  <select class="form-control" name="talla_franela">
                                      <option>XS</option>
                                      <option>S</option>
                                      <option>M</option>
                                      <option>L</option>
                              ...
                              <div class="form-group col-md-4">
                                  <label for="talla_short" class="control-label">Talla de Short:</label>
                                  <input type="number" class="form-control" id="talla_short" name="talla_short" placeholder="Ej: 40" maxlength="2" min="25" max="55">
                              </div>
                              <div class="form-group col-md-12">
                                  <label for="observaciones" class="control-label">Observaciones:</label>
                          ...
                          <section>
                              <div class="form-group col-md-12">
                                  <img id="preview-new-atleta" src="#"/>
                              </div>
                              <div class="form-group col-md-12">
                                  <label for="foto_carnet" class="control-label">Foto del Atleta:</label>
                                  <input type="file" name="foto_carnet" class="form-control" onchange="PreviewImage(this, '#preview-new-atleta');">
                              </div>
                          </section>
                      </div>
                  </form>
              ...
              <div class="modal-footer">
                  <button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Cerrar</button>
                  <button hidden type="submit" form="form-nuevo-atleta" class="btn btn-danger waves-effect waves-light">Registrar atleta</button>
              </div>
          </div>
          <!-- /.modal-content -->
      </div>
  ...
  <!-- Modal Actualizar Atleta -->
  <div class="modal fade actualizar-atleta" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header">
                  <h4 class="modal-title" id="myLargeModalLabel">Actualizar atleta</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              </div>
              <div class="modal-body">
                  <form id="form-actualizar-atleta" class="row" enctype="multipart/form-data">
                      <div class="this-for-steps">
                          <h3>Principal</h3>
                          <section>
                            <div class="row">
...
@section('scripts')
   ...
   <script src="{{ asset('js/atleta/scripts.js') }}"></script> 
@endsection